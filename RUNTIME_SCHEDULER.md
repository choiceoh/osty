...
void osty_rt_sched_concurrent_stop_request_v1(void);    // concurrent-collector STW enter
void osty_rt_sched_concurrent_stop_release_v1(void);    // concurrent-collector STW exit
```

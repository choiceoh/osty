...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ gate removed (2026-07). `PrepareEntry` always injects stdlib bodies; env var retired |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ → gate removed (2026-07).

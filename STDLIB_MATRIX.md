...
| gui.webview2 | 223 | Windows WebView2 C ABI shim. Safe wrapper / scaffold / runtime diagnostics landed; local virtual-origin assets and handle-lifetime hardening added; Windows smoke and packaged linker flow still pending |

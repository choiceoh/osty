...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ gate removed — `PrepareEntry` always injects bodied stdlib methods (2026-06) |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ — gate removed; injection is unconditional.

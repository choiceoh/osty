...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ gate removed (2026-06, feature-flag cleanup). `PrepareEntry` always injects bodied stdlib helpers; env var retired |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ — done; gate removed.

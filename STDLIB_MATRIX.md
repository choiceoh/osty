...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ gate retired (2026-06). `PrepareEntry` always injects bodied stdlib helpers |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ — gate retired (2026-06); injection always on.

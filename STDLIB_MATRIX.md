...
(stage0 부트스트랩 4분 12초) / stdlib 본문 인젝션 기본 경로.
...
| 15 | ~~OSTY_STDLIB_BODY_LOWER~~ | **제거됨** (2026-05-26) — stdlib 본문 인젝션은 항상 활성. 이전 escape hatch 는 `internal/backend/entry.go` 의 env gate |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ → 완료 후 게이트 제거 (항상 인젝션).

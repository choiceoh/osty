...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ default-on (2026-05-23, PR3-C 종착점). escape hatch (`OSTY_STDLIB_BODY_LOWER=0`) 유지 — redundant `=1` test wiring 제거됨; 게이트 자체 제거는 남은 `=0` bisect 소비자 해소 후 |

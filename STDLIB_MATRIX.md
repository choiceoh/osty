...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ default-on (2026-05-23, PR3-C 종착점). escape hatch (`OSTY_STDLIB_BODY_LOWER=0`) retained for bisect + tests that pin OFF (`llvm_keychain_test`, map-keys optimizer elision). Full gate removal blocked until those tests migrate |

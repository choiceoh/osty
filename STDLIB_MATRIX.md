...
| 15 | OSTY_STDLIB_BODY_LOWER | ✅ gate removed (2026-06, post-PR3-C CI proof). Injection is unconditional in `PrepareEntry`. |
...
6. ~~**OSTY_STDLIB_BODY_LOWER default-on flip**~~ — **done** (gate removed 2026-06 after CI proof).

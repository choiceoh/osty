...
async frame root, runtime frame mutation을 구분한다. Prototype은 object graph edge와
closure capture rewrite를 이 ABI로 낮췄고, 나머지 generated-code store lowering은
Phase 18 이후 같은 slot taxonomy를 사용한다.

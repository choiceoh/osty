# Osty Language Specification v0.3
...
**Status.** v0.3 — supersedes v0.2. Resolves all remaining open gaps (G4, G8–G12) and nails down 91 additional ambiguities surfaced by a full audit of v0.2. No known open gaps remain at the time of this release. See [`18-change-history.md`](./18-change-history.md) for the full v0.1 → v0.2 → v0.3 evolution.

**Companion documents.**

- `../OSTY_GRAMMAR_v0.3.md` — formal grammar (R1–R26 + EBNF). The lexer/parser ground truth.
- `../SPEC_GAPS.md` — archive of resolved gaps per version. No open items as of v0.3.

...
- LIR Proto production wiring + env matrix: [`/README.md`](../../README.md) (Bootstrap env-var reference), [`/ARCHITECTURE.md`](../../ARCHITECTURE.md) (LIR Proto subprocess bridge), [`/docs/lir_proto_plan.md`](../lir_proto_plan.md)

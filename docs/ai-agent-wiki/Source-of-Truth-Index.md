...
- bootstrap recovery playbook (layered fallbacks): [`/docs/security/bootstrap-recovery.md`](../security/bootstrap-recovery.md)
- self-rebuild ratchet + LIR Proto subprocess env vars: README **Self-rebuild ratchet** / **LIR Proto subprocess**; implementation detail in ARCHITECTURE **LIR Proto subprocess bridge**

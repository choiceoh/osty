...
- self-rebuild ratchet: [`scripts/verify-self-rebuild`](../../scripts/verify-self-rebuild), [`README.md`](../../README.md) **Self-rebuild ratchet**
- LIR Proto subprocess env matrix: [`README.md`](../../README.md) bootstrap env-var table, [`ARCHITECTURE.md`](../../ARCHITECTURE.md) **LIR Proto subprocess bridge**

...
- bootstrap disaster recovery: [`/docs/security/bootstrap-recovery.md`](../security/bootstrap-recovery.md)
- self-rebuild ratchet script: `/scripts/verify-self-rebuild` (recipes in `/justfile`)

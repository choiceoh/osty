...
- LIR Proto subprocess env vars + self-rebuild ratchet:
  [`/README.md`](../../README.md) (**Bootstrap env-var reference**, **Self-rebuild ratchet**)
  and [`/ARCHITECTURE.md`](../../ARCHITECTURE.md) (**LIR Proto subprocess bridge**)

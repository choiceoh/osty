...
>
> **Historical snapshot**: §0 아래 수치는 **2026-05-11** 측정값이다. Stage0
> **audit** cover 는 PR #2023 (2026-05-26) 이후 **100%**
> (`OSTY_STAGE0_AUDIT=1 go test -run TestStage0ToolchainAudit ./internal/backend/`).
> 남은 블로커는 audit % 가 아니라 LIR Proto / monomorph / cross-pkg link 축이다
> (`SPEC_GAPS.md`, `docs/llvm-selfhost-plan.md`).

## 0. 현 측정 (2026-05-11, superseded for audit %)

...
>
> **Historical note (2026-05-17)**: PR [#1858](https://github.com/choiceoh/osty/pull/1858) closed the stage0 audit trajectory at **100.0% (8240 / 8241)** via `TestStage0ToolchainAudit`. §0 아래 측정값(94.2%, 1340 declines)은 P24 스코프 작성 시점(2026-05-11) 스냅샷이다. 후속 작업은 audit-pass ≠ build-pass 격차(`install-self`, monomorph, LIR Proto)를 [`SPEC_GAPS.md`](../SPEC_GAPS.md) 타임라인에서 추적한다.

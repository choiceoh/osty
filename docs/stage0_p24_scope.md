...
> **Historical snapshot (2026-05-11).** Stage0 audit cover reached **100%**
> (PR [#1858](https://github.com/choiceoh/osty/pull/1858), revalidated PR
> [#2023](https://github.com/choiceoh/osty/pull/2023)). The P24 function
> targets below were planning inputs before that milestone; keep them for
> shape-analysis context, not as current coverage metrics. Live audit:

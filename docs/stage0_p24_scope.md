...
>
> **Superseded metrics (2026-05-17)**: `TestStage0ToolchainAudit` reached
> **100.0% (8240 / 8241)** after PR [#1858](https://github.com/choiceoh/osty/pull/1858).
> The §0 table below is a **2026-05-11 snapshot** kept for P24 shape
> analysis only. Current operator commands and audit scope limits are in
> [`docs/llvm-selfhost-plan.md`](llvm-selfhost-plan.md) §3.1 and
> [`SPEC_GAPS.md`](../SPEC_GAPS.md) (`cross-pkg-module-resolution`).

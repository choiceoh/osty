...
// functions or script files, integer println expressions, immutable scalar
// lets, mutable scalar locals, simple Int/Bool helper functions,
...
// renderers, scalar instruction builders, LLVM toolchain command plans,

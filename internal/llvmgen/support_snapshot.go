...
func llvmMapRuntimeValuesSymbol() string {
	return "osty_rt_map_values"
}

// Osty: toolchain/llvmgen.osty:1693:5
func llvmMapRuntimeLenSymbol() string {
	return "osty_rt_map_len"
}

// Osty: toolchain/llvmgen.osty:1697:5
func llvmMapRuntimeClearSymbol() string {
...
func llvmSetRuntimeClearSymbol() string {
	return "osty_rt_set_clear"
}
...
func llvmSmokeExecutableCorpus() []*LlvmSmokeExecutableCase {
	return []*LlvmSmokeExecutableCase{
		{name: "minimal", fixture: "minimal_print.osty", stdout: "42\n"},
		{name: "scalar", fixture: "scalar_arithmetic.osty", stdout: "42\n"},
		{name: "control", fixture: "control_flow.osty", stdout: "15\n"},
		{name: "booleans", fixture: "booleans.osty", stdout: "7\n"},
		{name: "string", fixture: "string_print.osty", stdout: "hello, osty\n"},
		{name: "string-escape", fixture: "string_escape_print.osty", stdout: "line one\nquote \" slash \\\n"},
		{name: "string-let", fixture: "string_let_print.osty", stdout: "stored string\n"},
		{name: "string-return", fixture: "string_return_print.osty", stdout: "from function\n"},
		{name: "string-param", fixture: "string_param_print.osty", stdout: "param string\n"},
		{name: "string-mut", fixture: "string_mut_print.osty", stdout: "after\n"},
		{name: "struct-field", fixture: "struct_field_print.osty", stdout: "42\n"},
		{name: "struct-return", fixture: "struct_return_print.osty", stdout: "42\n"},
		{name: "struct-param", fixture: "struct_param_print.osty", stdout: "42\n"},
		{name: "struct-mut", fixture: "struct_mut_print.osty", stdout: "42\n"},
		{name: "enum-variant", fixture: "enum_variant_print.osty", stdout: "42\n"},
		{name: "enum-return", fixture: "enum_return_print.osty", stdout: "42\n"},
		{name: "enum-param", fixture: "enum_param_print.osty", stdout: "42\n"},
		{name: "enum-mut", fixture: "enum_mut_print.osty", stdout: "42\n"},
		{name: "enum-match", fixture: "enum_match_print.osty", stdout: "42\n"},
		{name: "enum-match-return", fixture: "enum_match_return_print.osty", stdout: "42\n"},
		{name: "enum-match-param", fixture: "enum_match_param_print.osty", stdout: "42\n"},
		{name: "enum-match-mut", fixture: "enum_match_mut_print.osty", stdout: "42\n"},
		{name: "enum-payload", fixture: "enum_payload_print.osty", stdout: "42\n"},
		{name: "enum-payload-return", fixture: "enum_payload_return_print.osty", stdout: "42\n"},
		{name: "enum-payload-param", fixture: "enum_payload_param_print.osty", stdout: "42\n"},
		{name: "enum-payload-mut", fixture: "enum_payload_mut_print.osty", stdout: "42\n"},
		{name: "float-print", fixture: "float_print.osty", stdout: "42.000000\n"},
		{name: "float-arithmetic", fixture: "float_arithmetic_print.osty", stdout: "42.000000\n"},
		{name: "float-return", fixture: "float_return_print.osty", stdout: "42.000000\n"},
		{name: "float-param", fixture: "float_param_print.osty", stdout: "42.000000\n"},
		{name: "float-mutable", fixture: "float_mut_print.osty", stdout: "42.000000\n"},
		{name: "float-compare", fixture: "float_compare_print.osty", stdout: "42.000000\n"},
		{name: "float-struct", fixture: "float_struct_print.osty", stdout: "42.000000\n"},
		{name: "float-enum-payload", fixture: "float_enum_payload_print.osty", stdout: "42.000000\n"},
		{name: "float-payload-return", fixture: "float_payload_return_print.osty", stdout: "42.000000\n"},
		{name: "float-payload-param", fixture: "float_payload_param_print.osty", stdout: "42.000000\n"},
		{name: "float-payload-mut", fixture: "float_payload_mut_print.osty", stdout: "42.000000\n"},
		{name: "float-payload-reversed", fixture: "float_payload_reversed_match_print.osty", stdout: "42.000000\n"},
		{name: "float-payload-wildcard", fixture: "float_payload_wildcard_print.osty", stdout: "42.000000\n"},
		{name: "string-payload-return", fixture: "string_payload_return_print.osty", stdout: "payload string\n"},
		{name: "string-payload-param", fixture: "string_payload_param_print.osty", stdout: "payload string\n"},
		{name: "string-payload-mut", fixture: "string_payload_mut_print.osty", stdout: "payload string\n"},
		{name: "string-payload-reversed", fixture: "string_payload_reversed_match_print.osty", stdout: "payload string\n"},
		{name: "string-payload-wildcard", fixture: "string_payload_wildcard_print.osty", stdout: "payload string\n"},
		{name: "int-if-expr", fixture: "int_if_expr_print.osty", stdout: "42\n"},
		{name: "string-if-expr", fixture: "string_if_expr_print.osty", stdout: "chosen string\n"},
		{name: "float-if-expr", fixture: "float_if_expr_print.osty", stdout: "42.000000\n"},
		{name: "bool-param-return", fixture: "bool_param_return_print.osty", stdout: "42\n"},
		{name: "int-range-exclusive", fixture: "int_range_exclusive_print.osty", stdout: "21\n"},
		{name: "int-unary", fixture: "int_unary_print.osty", stdout: "42\n"},
		{name: "int-modulo", fixture: "int_modulo_print.osty", stdout: "42\n"},
		{name: "struct-string-field", fixture: "struct_string_field_print.osty", stdout: "struct string\n"},
		{name: "struct-bool-field", fixture: "struct_bool_field_print.osty", stdout: "42\n"},
		{name: "bool-mut", fixture: "bool_mut_print.osty", stdout: "42\n"},
		{name: "result-question-int", fixture: "result_question_int_print.osty", stdout: "42\n"},
		{name: "enum-multi-field-payload", fixture: "enum_multi_field_payload_print.osty", stdout: "12\n7\n0\n"},
		{name: "coalesce-ptr", fixture: "coalesce_ptr_print.osty", stdout: "anonymous\nAda\n"},
		{name: "coalesce-int", fixture: "coalesce_int_print.osty", stdout: "0\n42\n"},
		{name: "if-let-payload-stmt", fixture: "if_let_payload_stmt_print.osty", stdout: "42\n0\n"},
		{name: "if-let-payload-expr", fixture: "if_let_payload_expr_print.osty", stdout: "42\n0\n"},
		{name: "if-let-qualified-variant", fixture: "if_let_qualified_variant_print.osty", stdout: "42\n0\n"},
	}
}

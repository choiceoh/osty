...
func TestLIRProtoCurrentGeneratorSourceFixturesShadowParity(t *testing.T) {
	...
	if got, want := len(fixtures), 55; got != want {
...
func TestLIRProtoManualFixtureCatalog(t *testing.T) {
	...
	want := []struct {
		...
		{"lirParityManualListPushBytesV1Fixture", []string{"%Cell = type", "declare void @osty_rt_list_push_bytes_v1(ptr, ptr, i64)", "alloca %Cell", "getelementptr %Cell, ptr null, i32 1", "ptrtoint ptr", "call void @osty_rt_list_push_bytes_v1("}},
		...
		{"lirParityManualListGetBytesV1Fixture", []string{"%Cell = type", "declare void @osty_rt_list_get_bytes_v1(ptr, i64, ptr, i64)", "alloca %Cell", "getelementptr %Cell, ptr null, i32 1", "call void @osty_rt_list_get_bytes_v1(", "load %Cell"}},
		...
		{"lirParityManualAggListStructBytesV1Fixture", []string{"%Pair = type { i64, i64 }", "declare ptr @osty_rt_list_new()", "declare void @osty_rt_list_push_bytes_v1(ptr, ptr, i64)", "call ptr @osty_rt_list_new()", "alloca %Pair", "store %Pair", "getelementptr %Pair, ptr null, i32 1", "ptrtoint ptr", "call void @osty_rt_list_push_bytes_v1(", "ret ptr"}},
		{"lirParityManualListRemoveAtStructBytesV1Fixture", []string{"%Pair = type { i64, i64 }", "declare void @osty_rt_list_get_bytes_v1(ptr, i64, ptr, i64)", "declare void @osty_rt_list_remove_at_discard(ptr, i64)", "alloca %Pair", "getelementptr %Pair, ptr null, i32 1", "ptrtoint ptr", "call void @osty_rt_list_get_bytes_v1(", "load %Pair", "call void @osty_rt_list_remove_at_discard(", "ret %Pair"}},
		...
		{"lirParityManualAggEnumVariantSomeStructFixture", []string{"%Pair = type { i64, i64 }", "%Option.Pair = type", "declare ptr @osty.gc.alloc_v1(i64, i64, ptr)", "getelementptr %Pair, ptr null, i32 1", "ptrtoint ptr", "call ptr @osty.gc.alloc_v1(i64 1, i64", "store %Pair", "insertvalue %Option.Pair undef, i64 1, 0", "ret %Option.Pair"}},

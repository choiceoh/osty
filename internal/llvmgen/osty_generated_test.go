...
func TestGeneratedListRuntimeDeclarationsAreOstyOwned(t *testing.T) {
	...
	want := []string{
		...
		"declare void @osty_rt_list_insert_string(ptr, i64, ptr)",
	}
	for _, w := range want {
...
func TestGeneratedSetRuntimeSymbolsAreOstyOwned(t *testing.T) {
	cases := []struct {
		...
		{"clear", llvmSetRuntimeClearSymbol(), "osty_rt_set_clear"},
...
func TestGeneratedStringRuntimeSymbolsAreOstyOwned(t *testing.T) {
	cases := []struct {
		...
		{"toUpper", llvmStringRuntimeToUpperSymbol(), "osty_rt_strings_ToUpper"},
		{"toLower", llvmStringRuntimeToLowerSymbol(), "osty_rt_strings_ToLower"},
		{"isValidInt", llvmStringRuntimeIsValidIntSymbol(), "osty_rt_strings_IsValidInt"},
		{"toInt", llvmStringRuntimeToIntSymbol(), "osty_rt_strings_ToInt"},
		{"isValidFloat", llvmStringRuntimeIsValidFloatSymbol(), "osty_rt_strings_IsValidFloat"},
		{"toFloat", llvmStringRuntimeToFloatSymbol(), "osty_rt_strings_ToFloat"},
...
func TestGeneratedMapRuntimeSymbolsAreOstyOwned(t *testing.T) {
	cases := []struct {
		...
		{"values", llvmMapRuntimeValuesSymbol(), "osty_rt_map_values"},
		{"clear", llvmMapRuntimeClearSymbol(), "osty_rt_map_clear"},

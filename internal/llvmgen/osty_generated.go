...
// Osty source: toolchain/llvmgen.osty
...
// Osty: toolchain/llvmgen.osty:323:5
func llvmGcRootRelease(emitter *LlvmEmitter, value *LlvmValue) {
	// Osty: toolchain/llvmgen.osty:324:5
...
func llvmCString(text string) *LlvmCString {
	// Osty: toolchain/llvmgen.osty:384:5
	encoded := fmt.Sprintf("%s\\00", ostyToString(llvmCStringEscape(text)))
	_ = encoded
	// Osty: toolchain/llvmgen.osty:385:5
	byteLen := func() int {
...
func llvmCStringEscape(text string) string {
	// Osty: toolchain/llvmgen.osty:390:5
	encoded := ""
	_ = encoded
	// Osty: toolchain/llvmgen.osty:391:5
	for _, unit := range llvmStrings.Split(text, "") {
		// Osty: toolchain/llvmgen.osty:392:9
		if unit == "\n" {
			// Osty: toolchain/llvmgen.osty:393:13
			encoded = fmt.Sprintf("%s\\0A", ostyToString(encoded))
		} else if unit == "\t" {
			// Osty: toolchain/llvmgen.osty:395:13
			encoded = fmt.Sprintf("%s\\09", ostyToString(encoded))
		} else if unit == "\r" {
			// Osty: toolchain/llvmgen.osty:397:13
			encoded = fmt.Sprintf("%s\\0D", ostyToString(encoded))
		} else if unit == "\"" {
			// Osty: toolchain/llvmgen.osty:399:13
			encoded = fmt.Sprintf("%s\\22", ostyToString(encoded))
		} else if unit == "\\" {
			// Osty: toolchain/llvmgen.osty:401:13
			encoded = fmt.Sprintf("%s\\5C", ostyToString(encoded))
		} else {
			// Osty: toolchain/llvmgen.osty:403:13
...
func llvmClangLinkBinaryArgs(target string, objectPath string, binaryPath string) []string {
	...
	func() struct{} { args = append(args, objectPath); return struct{}{} }()
	// Osty: toolchain/llvmgen.osty:724:5
	func() struct{} { args = append(args, "-o"); return struct{}{} }()
	// Osty: toolchain/llvmgen.osty:725:5
	func() struct{} { args = append(args, binaryPath); return struct{}{} }()
	return args
}

// Osty: toolchain/llvmgen.osty:729:5
...
// Osty: toolchain/llvmgen.osty:737:5
...
// Osty: toolchain/llvmgen.osty:744:5
func llvmUnsupportedBackendErrorMessage() string {
	return "llvm backend: code generation is not implemented yet"
}

// Osty: toolchain/llvmgen.osty:748:5
func llvmUnsupportedDiagnostic(kind string, detail string) *LlvmUnsupportedDiagnostic {
	// Osty: toolchain/llvmgen.osty:749:5
	if kind == "go-ffi" {
		// Osty: toolchain/llvmgen.osty:750:9
		target := detail
		_ = target
		// Osty: toolchain/llvmgen.osty:751:9
		if target == "" {
			// Osty: toolchain/llvmgen.osty:752:13
			target = "<unknown>"
		}
		// Osty: toolchain/llvmgen.osty:754:9
	...
	if kind == "runtime-ffi" {
		// Osty: toolchain/llvmgen.osty:762:9
		target := detail
		_ = target
		// Osty: toolchain/llvmgen.osty:763:9
		if target == "" {
			// Osty: toolchain/llvmgen.osty:764:13
			target = "<unknown>"
		}
		// Osty: toolchain/llvmgen.osty:766:9
	...
	if kind == "source-layout" {
		// Osty: toolchain/llvmgen.osty:775:9
	...
	if kind == "type-system" {
		// Osty: toolchain/llvmgen.osty:783:9
	...
	if kind == "statement" {
		// Osty: toolchain/llvmgen.osty:791:9
	...
	// Osty: toolchain/llvmgen.osty:798:5
	if kind == "expression" {
		// Osty: toolchain/llvmgen.osty:799:9
	...
	if kind == "control-flow" {
		// Osty: toolchain/llvmgen.osty:807:9
	...
	// Osty: toolchain/llvmgen.osty:814:5
	if kind == "call" {
		// Osty: toolchain/llvmgen.osty:815:9
	...
	if kind == "name" {
		// Osty: toolchain/llvmgen.osty:823:9
	...
	if kind == "function-signature" {
		// Osty: toolchain/llvmgen.osty:831:9
	...
	// Osty: toolchain/llvmgen.osty:839:5
	reason := detail
	_ = reason
...
func llvmUnsupportedDiagnosticWith(code string, kind string, detail string, hint string) *LlvmUnsupportedDiagnostic {
	// Osty: toolchain/llvmgen.osty:857:5
	reason := detail
	_ = reason
	// Osty: toolchain/llvmgen.osty:858:5
	if reason == "" {
		// Osty: toolchain/llvmgen.osty:859:9
		reason = "source shape is not supported by the current LLVM backend"
	}
...
// Osty: toolchain/llvmgen.osty:1112:5
func llvmSmokeGcRuntimeAbiIR(sourcePath string) string {
	...
	// Osty: toolchain/llvmgen.osty:1116:5
	...
	// Osty: toolchain/llvmgen.osty:1119:5
...
// Osty: toolchain/llvmgen.osty:1132:5
func llvmSmokeScalarArithmeticIR(sourcePath string) string {
	...
	// Osty: toolchain/llvmgen.osty:1135:5
	llvmBind(add, "b", llvmI64("%b"))
	// Osty: toolchain/llvmgen.osty:1136:5
	sum := llvmBinaryI64(add, "add", llvmIdent(add, "a"), llvmIdent(add, "b"))
	_ = sum
	// Osty: toolchain/llvmgen.osty:1137:5
	llvmReturn(add, sum)
	...
	_ = labels
	// Osty: toolchain/llvmgen.osty:1144:5
	llvmPrintlnI64(main, llvmIdent(main, "value"))
	// Osty: toolchain/llvmgen.osty:1145:5
	llvmIfElse(main, labels)
	// Osty: toolchain/llvmgen.osty:1146:5
...
func llvmSmokeControlFlowIR(sourcePath string) string {
	...
	_ = nextTotal
	// Osty: toolchain/llvmgen.osty:1174:5
	...
	// Osty: toolchain/llvmgen.osty:1178:5
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1179:5
...
func llvmSmokeBooleansIR(sourcePath string) string {
	...
	_ = result
	// Osty: toolchain/llvmgen.osty:1206:5
	...
	_ = value
	// Osty: toolchain/llvmgen.osty:1210:5
	llvmPrintlnI64(main, value)
	// Osty: toolchain/llvmgen.osty:1211:5
	llvmReturnI32Zero(main)
...
func llvmSmokeStringLetIR(sourcePath string) string {
	...
	_ = msg
	// Osty: toolchain/llvmgen.osty:1266:5
	llvmImmutableLet(main, "msg", msg)
	// Osty: toolchain/llvmgen.osty:1267:5
	llvmPrintlnString(main, llvmIdent(main, "msg"))
	// Osty: toolchain/llvmgen.osty:1268:5
	llvmReturnI32Zero(main)
	return llvmRenderModuleWithGlobals(sourcePath, "", main.stringGlobals, []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
func llvmSmokeStringReturnIR(sourcePath string) string {
	...
	greet := llvmEmitter()
	_ = greet
	// Osty: toolchain/llvmgen.osty:1282:5
...
func llvmSmokeStringParamIR(sourcePath string) string {
	...
	_ = value
	// Osty: toolchain/llvmgen.osty:1306:5
	llvmPrintlnString(main, value)
	// Osty: toolchain/llvmgen.osty:1307:5
	llvmReturnI32Zero(main)
...
func llvmSmokeStringMutableIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1322:5
	llvmMutableLet(main, "msg", llvmStringLiteral(main, "before"))
	// Osty: toolchain/llvmgen.osty:1323:5
	_ = llvmAssign(main, "msg", llvmStringLiteral(main, "after"))
	// Osty: toolchain/llvmgen.osty:1324:5
	llvmPrintlnString(main, llvmIdent(main, "msg"))
	// Osty: toolchain/llvmgen.osty:1325:5
	llvmReturnI32Zero(main)
	return llvmRenderModuleWithGlobals(sourcePath, "", main.stringGlobals, []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
func llvmSmokeStructFieldIR(sourcePath string) string {
	...
	_ = point
	// Osty: toolchain/llvmgen.osty:1340:5
	llvmImmutableLet(main, "point", point)
	// Osty: toolchain/llvmgen.osty:1341:5
	...
	_ = sum
	// Osty: toolchain/llvmgen.osty:1347:5
	llvmPrintlnI64(main, sum)
	// Osty: toolchain/llvmgen.osty:1348:5
	llvmReturnI32Zero(main)
...
func llvmSmokeStructReturnIR(sourcePath string) string {
	...
	// Osty: toolchain/llvmgen.osty:1369:5
...
func llvmSmokeStructParamIR(sourcePath string) string {
	...
	_ = out
	// Osty: toolchain/llvmgen.osty:1404:5
...
func llvmSmokeStructMutableIR(sourcePath string) string {
	...
	// Osty: toolchain/llvmgen.osty:1422:5
...
func llvmSmokeEnumVariantIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1438:5
	main := llvmEmitter()
	_ = main
	...
	_ = cond
	// Osty: toolchain/llvmgen.osty:1441:5
	labels := llvmIfStart(main, cond)
	_ = labels
...
func llvmSmokeEnumReturnIR(sourcePath string) string {
	...
	_ = state
	// Osty: toolchain/llvmgen.osty:1463:5
	...
	llvmPrintlnI64(main, llvmIntLiteral(42))
	// Osty: toolchain/llvmgen.osty:1466:5
	llvmIfElse(main, labels)
	// Osty: toolchain/llvmgen.osty:1467:5
	llvmPrintlnI64(main, llvmIntLiteral(0))
	// Osty: toolchain/llvmgen.osty:1468:5
	llvmIfEnd(main, labels)
	// Osty: toolchain/llvmgen.osty:1469:5
	llvmReturnI32Zero(main)
...
func llvmSmokeEnumParamIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1482:5
	score := llvmEmitter()
	_ = score
	...
	_ = cond
	// Osty: toolchain/llvmgen.osty:1485:5
	...
	// Osty: toolchain/llvmgen.osty:1488:5
...
// Osty: toolchain/llvmgen.osty:1507:5
func llvmSmokeEnumMutableIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1508:5
	main := llvmEmitter()
	_ = main
	...
	_ = cond
	// Osty: toolchain/llvmgen.osty:1512:5
	labels := llvmIfStart(main, cond)
	_ = labels
...
// Osty: toolchain/llvmgen.osty:1528:5
func llvmSmokeEnumMatchIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1529:5
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1530:5
	llvmImmutableLet(main, "state", llvmEnumVariant("Switch", 1))
	// Osty: toolchain/llvmgen.osty:1531:5
	cond := llvmCompare(main, "eq", llvmIdent(main, "state"), llvmEnumVariant("Switch", 1))
	_ = cond
	// Osty: toolchain/llvmgen.osty:1532:5
...
func llvmSmokeEnumMatchReturnIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1550:5
	pick := llvmEmitter()
	_ = pick
	// Osty: toolchain/llvmgen.osty:1551:5
	llvmReturn(pick, llvmEnumVariant("Switch", 1))
	// Osty: toolchain/llvmgen.osty:1553:5
	score := llvmEmitter()
	_ = score
	...
	labels := llvmIfExprStart(score, cond)
	_ = labels
	// Osty: toolchain/llvmgen.osty:1557:5
	thenValue := llvmIntLiteral(42)
	_ = thenValue
...
func llvmSmokeEnumMatchParamIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1591:5
	out := llvmCall(main, "i64", "score", []*LlvmValue{llvmEnumVariant("Switch", 1)})
	_ = out
	// Osty: toolchain/llvmgen.osty:1592:5
	llvmPrintlnI64(main, out)
	// Osty: toolchain/llvmgen.osty:1593:5
	llvmReturnI32Zero(main)
	return llvmRenderModule(sourcePath, "", []string{llvmRenderFunction("i64", "score", []*LlvmParam{llvmParam("state", "i64")}, score.body), llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
// Osty: toolchain/llvmgen.osty:1627:5
func llvmSmokeEnumPayloadIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1628:5
	main := llvmEmitter()
	_ = main
...
func llvmSmokeEnumPayloadParamIR(sourcePath string) string {
	...
	labels := llvmIfExprStart(score, cond)
	_ = labels
	// Osty: toolchain/llvmgen.osty:1692:5
	thenValue := llvmExtractValue(score, state, "i64", 1)
	_ = thenValue
	// Osty: toolchain/llvmgen.osty:1693:5
	llvmIfExprElse(score, labels)
	// Osty: toolchain/llvmgen.osty:1694:5
	elseValue := llvmIntLiteral(0)
	_ = elseValue
	// Osty: toolchain/llvmgen.osty:1695:5
	result := llvmIfExprEnd(score, "i64", thenValue, elseValue, labels)
	_ = result
	// Osty: toolchain/llvmgen.osty:1696:5
	llvmReturn(score, result)
	...
	_ = arg
	// Osty: toolchain/llvmgen.osty:1700:5
...
func llvmSmokeEnumPayloadMutableIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1718:5
	...
	cond := llvmCompare(main, "eq", tag, llvmEnumVariant("Maybe", 0))
	_ = cond
	// Osty: toolchain/llvmgen.osty:1723:5
	labels := llvmIfExprStart(main, cond)
	_ = labels
	...
	llvmIfExprElse(main, labels)
	// Osty: toolchain/llvmgen.osty:1726:5
	elseValue := llvmIntLiteral(0)
	_ = elseValue
	// Osty: toolchain/llvmgen.osty:1727:5
	result := llvmIfExprEnd(main, "i64", thenValue, elseValue, labels)
	_ = result
...
func llvmSmokeFloatArithmeticIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1755:5
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1756:5
	...
	_ = mul
	// Osty: toolchain/llvmgen.osty:1759:5
	div := llvmBinaryF64(main, "fdiv", mul, llvmFloatLiteral("2.5"))
	_ = div
	// Osty: toolchain/llvmgen.osty:1760:5
	llvmPrintlnF64(main, div)
	// Osty: toolchain/llvmgen.osty:1761:5
	llvmReturnI32Zero(main)
	return llvmRenderModule(sourcePath, "", []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
// Osty: toolchain/llvmgen.osty:1789:5
func llvmSmokeFloatParamIR(sourcePath string) string {
	// Osty: toolchain/llvmgen.osty:1790:5
	score := llvmEmitter()
	_ = score
	// Osty: toolchain/llvmgen.osty:1791:5
	llvmBind(score, "value", llvmF64("%value"))
	// Osty: toolchain/llvmgen.osty:1792:5
...
func llvmSmokeFloatMutableIR(sourcePath string) string {
	...
	// Osty: toolchain/llvmgen.osty:1814:5
	llvmReturnI32Zero(main)
	return llvmRenderModule(sourcePath, "", []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}

// Osty: toolchain/llvmgen.osty:1825:5
func llvmSmokeFloatCompareIR(sourcePath string) string {
	...
	_ = cond
	// Osty: toolchain/llvmgen.osty:1840:5
	labels := llvmIfStart(main, cond)
	_ = labels
	...
	llvmIfEnd(main, labels)
	// Osty: toolchain/llvmgen.osty:1845:5
	llvmReturnI32Zero(main)
	return llvmRenderModule(sourcePath, "", []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
func llvmSmokeFloatStructIR(sourcePath string) string {
	...
	_ = value
	// Osty: toolchain/llvmgen.osty:1857:5
	llvmImmutableLet(main, "value", value)
...
func llvmSmokeFloatEnumPayloadIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1874:5
	value := llvmEnumPayloadVariant(main, "%MaybeF", 0, llvmFloatLiteral("42.0"))
	_ = value
	// Osty: toolchain/llvmgen.osty:1875:5
	llvmImmutableLet(main, "value", value)
...
func llvmSmokeFloatPayloadReturnIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1914:5
...
func llvmSmokeFloatPayloadParamIR(sourcePath string) string {
	...
	labels := llvmIfExprStart(score, cond)
	_ = labels
	// Osty: toolchain/llvmgen.osty:1938:5
	thenValue := llvmExtractValue(score, valueRef, "double", 1)
	_ = thenValue
	// Osty: toolchain/llvmgen.osty:1939:5
	llvmIfExprElse(score, labels)
	// Osty: toolchain/llvmgen.osty:1940:5
	elseValue := llvmFloatLiteral("0.0")
	_ = elseValue
	// Osty: toolchain/llvmgen.osty:1941:5
	out := llvmIfExprEnd(score, "double", thenValue, elseValue, labels)
	_ = out
	// Osty: toolchain/llvmgen.osty:1942:5
	llvmReturn(score, out)
	// Osty: toolchain/llvmgen.osty:1944:5
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1945:5
	arg := llvmEnumPayloadVariant(main, "%FloatMaybe", 0, llvmFloatLiteral("42.0"))
	_ = arg
	// Osty: toolchain/llvmgen.osty:1946:5
	mainOut := llvmCall(main, "double", "score", []*LlvmValue{arg})
	_ = mainOut
	// Osty: toolchain/llvmgen.osty:1947:5
	llvmPrintlnF64(main, mainOut)
	// Osty: toolchain/llvmgen.osty:1948:5
	llvmReturnI32Zero(main)
...
func llvmSmokeFloatPayloadMutableIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:1964:5
	...
	labels := llvmIfExprStart(main, cond)
	_ = labels
	// Osty: toolchain/llvmgen.osty:1970:5
	thenValue := llvmExtractValue(main, valueRef, "double", 1)
	_ = thenValue
	// Osty: toolchain/llvmgen.osty:1971:5
	llvmIfExprElse(main, labels)
	// Osty: toolchain/llvmgen.osty:1972:5
	elseValue := llvmFloatLiteral("0.0")
	_ = elseValue
	// Osty: toolchain/llvmgen.osty:1973:5
	out := llvmIfExprEnd(main, "double", thenValue, elseValue, labels)
	_ = out
	// Osty: toolchain/llvmgen.osty:1974:5
	llvmPrintlnF64(main, out)
...
func llvmSmokeStringPayloadReturnIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:2056:5
	value := llvmCall(main, "ptr", "score", make([]*LlvmValue, 0, 1))
	_ = value
	// Osty: toolchain/llvmgen.osty:2057:5
	llvmPrintlnString(main, value)
...
func llvmSmokeStringPayloadParamIR(sourcePath string) string {
	...
	elseValue := llvmStringLiteral(score, "no payload")
	_ = elseValue
	// Osty: toolchain/llvmgen.osty:2083:5
	out := llvmIfExprEnd(score, "ptr", thenValue, elseValue, labels)
	_ = out
	// Osty: toolchain/llvmgen.osty:2084:5
	llvmReturn(score, out)
	// Osty: toolchain/llvmgen.osty:2086:5
	main := llvmEmitter()
	_ = main
	...
	_ = value
	// Osty: toolchain/llvmgen.osty:2089:5
	llvmPrintlnString(main, value)
	// Osty: toolchain/llvmgen.osty:2090:5
	llvmReturnI32Zero(main)
...
func llvmSmokeStringPayloadMutableIR(sourcePath string) string {
	...
	main := llvmEmitter()
	_ = main
	// Osty: toolchain/llvmgen.osty:2106:5
...
func llvmSmokeStringPayloadReversedMatchIR(sourcePath string) string {
	...
	_ = cond
	// Osty: toolchain/llvmgen.osty:2137:5
	labels := llvmIfExprStart(main, cond)
	_ = labels
	...
	llvmPrintlnString(main, out)
	// Osty: toolchain/llvmgen.osty:2143:5
	llvmReturnI32Zero(main)
	return llvmRenderModuleWithGlobalsAndTypes(sourcePath, "", []string{llvmStructTypeDef("Label", []string{"i64", "ptr"})}, make([]*LlvmStringGlobal, 0, 1), []string{llvmRenderFunction("i32", "main", make([]*LlvmParam, 0, 1), main.body)})
}
...
// Osty: toolchain/llvmgen.osty:2182:1
func llvmCallArgs(args []*LlvmValue) string {
	...
	for _, arg := range args {
		// Osty: toolchain/llvmgen.osty:2185:9
		func() struct{} {
...
// Osty: toolchain/llvmgen.osty:2190:1
func llvmParams(params []*LlvmParam) string {
	...
	for _, param := range params {
		// Osty: toolchain/llvmgen.osty:2193:9
		func() struct{} {
...
// Osty: toolchain/llvmgen.osty:2198:1
func llvmNextTemp(emitter *LlvmEmitter) string {
	// Osty: toolchain/llvmgen.osty:2199:5
	name := fmt.Sprintf("%%t%s", ostyToString(emitter.temp))
	_ = name
	// Osty: toolchain/llvmgen.osty:2200:12

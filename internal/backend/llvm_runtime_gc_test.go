...
// through the young-page hook before the arena fast path. Default-on
// since Phase 8 step 2; `OSTY_GC_TINYTAG_YOUNG=0` is the kill switch
// for tests that need the legacy route.

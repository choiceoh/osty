...
func finalizeEntryIR(entry Entry, mod *ir.Module) (Entry, error) {
	// Stdlib body + generic type injection is unconditional (PR3-C
	// steady state). The former `OSTY_STDLIB_BODY_LOWER` escape hatch
	// was removed after default-on CI coverage.

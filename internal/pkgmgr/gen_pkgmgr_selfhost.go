...
var unusedGeneratedFunctions = []string{
	...
	"selfPkgGitDependency",
	"selfPkgGraphErrorCount",
	"selfPkgGraphNodeCount",
	"selfPkgGraphOrderCount",
	"selfPkgLockChangeCount",
	"selfPkgLockChangeKindEq",
	"selfPkgLockFromPlan",
	"selfPkgPlanFoundCount",
	"selfPkgRegistryDependency",
	"selfPkgRegistryStatusOK",
	"selfPkgResolveRegistryGraph",
	"selfPkgResolveRegistryPlan",
	"tildeReq",
	"versionWithBuild",
	"wildcardMajorReq",
	"wildcardMinorReq",
...
func formatGenerated(path string) error {
	...
	src, err := dropGeneratedFunctions(string(data), unusedGeneratedFunctions)
	if err != nil {
		return err
	}

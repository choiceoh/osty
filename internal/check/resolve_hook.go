...
// enough to register NativePackageCheck; after UseManagedSubprocessChecker /
// InstallSubprocessCheckerForPackageTests installs a subprocess factory,
// resolve's fact-artifact computation

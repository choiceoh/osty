	...
	cases := []struct {
	...
	}{
		{
			...
			needles: []string{
				...
				"declare ptr @osty_rt_chan_make",
				"declare void @osty_rt_chan_send",
				"declare ptr @osty_rt_chan_recv",
				...
				"declare ptr @osty_rt_list_sorted",
				"declare ptr @osty_rt_list_reversed",
				"declare ptr @osty_rt_list_to_set",
				"declare ptr @osty_rt_list_remove_at",
				"declare ptr @osty_rt_list_to_string",
				"declare ptr @osty_rt_map_to_string",
				"declare ptr @osty_rt_map_keys_sorted",
				...
				"declare ptr @osty_rt_race",
				"declare ptr @osty_rt_collect_all",
				"declare i64 @osty_rt_select_begin",
				"declare i8 @osty_rt_bytes_get",
				"declare i64 @osty_rt_bytes_indexOf",

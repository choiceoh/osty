...
user module before MIR. The `OSTY_STDLIB_BODY_LOWER` rollout gate was removed
after the PR3-C default-on path proved stable through CI (`just bootstrap` /
`fresh-clone-source-bootstrap.yml`).

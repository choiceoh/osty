...
user module before MIR. Injection is unconditional — the former
`OSTY_STDLIB_BODY_LOWER` rollout gate was removed after the default-on path
proved stable through CI (`just bootstrap` / `fresh-clone-source-bootstrap.yml`).

...
Osty-authored stdlib method bodies from `internal/stdlib/modules/` into
the user module before MIR. `just bootstrap` exercises the same path as
production `osty build`.
